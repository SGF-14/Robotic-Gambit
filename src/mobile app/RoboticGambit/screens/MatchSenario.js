...
const MatchSenario = () => {
  ...
  return (
    <View style={styles.matchSenario11}>
      <ImageBackground
      ...
      >
        <Text style={styles.text}>9:56</Text>
      </Pressable>
      <Pressable
      ...
      <Button
        style={styles.matchSenario11Child}
        mode="text"
        labelStyle={styles.frameButtonBtn}
        onPress={() => navigation.navigate("MatchSenario18Result")}
